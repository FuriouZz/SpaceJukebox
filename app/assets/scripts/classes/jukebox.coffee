class SPACE.Jukebox
  ...
  _eTrackAdded: (e)=>
    ...
    console.log 'Sound added: ' + e.object.track.data.title
    # console.log @list()
  ...
  _starting: (sound)=>
    @current.sound = sound
    # console.log @current.data.duration, @playlist[0].pendingDuration
    # console.log sound, @playlist[0].pendingDuration

  _onplay: =>
    console.log 'Next: ' + @current.data.title
